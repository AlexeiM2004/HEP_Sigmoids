...
plt.tight_layout()
plt.savefig("ttbar_analysis_larger_jets_4_tokens_fourth_order_8_heads_128dim.png")
plt.show()
...
# Save to file
np.savetxt(
    "ttbar_analysis_larger_jets_4_tokens_fourth_order_8_heads_128dim.txt", 
    results,
...
print("Saved predictions to ttbar_analysis_larger_jets_4_tokens_fourth_order_8_heads_128dim.txt")
print("Saved analysis plot to ttbar_analysis_larger_jets_4_tokens_fourth_order_8_heads_128dim.png")