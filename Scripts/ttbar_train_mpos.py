...
class GroupedTransformer(nn.Module):
    def __init__(self, d_model=64, nhead=4, num_layers=4, dropout=0.1):
        ...
        # Type embeddings
        self.type_embed = nn.Parameter(torch.randn(1, 4, d_model))
...
plt.tight_layout()
plt.savefig("../plots/ttbar_Mass_mpos.png")
plt.show()
...
# Save to file
np.savetxt(
    "../train_outputs/ttbar_mass_predictions_mpos.txt", 
    results,
...
print("Saved predictions to ../data/ttbar_mass_predictions_mpos.txt")
