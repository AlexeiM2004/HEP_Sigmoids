...
@dataclass
class Data_Saving:
    loss_r2_summary_plots : str = "MLA_train_no_scaling_loss_r2_summary_plots.png"
    target_feature_plots : str = "MLA_train_no_scaling_target_feature_plots.png"
    target_dimension_scatter_plots : str = "MLA_train_no_scaling_target_dimension_scatter_plots.png"
    invariant_mass_plots : str = "MLA_train_no_scaling_invariant_mass_plots.png"
    invariant_mass_data : str = "MLA_train_no_scaling_invariant_mass_data.txt"
