...
@dataclass
class Data_Saving:
    loss_r2_summary_plots : str = "MHA_train_no_mass_loss_loss_r2_summary_plots.png"
    target_feature_plots : str = "MHA_train_no_mass_loss_target_feature_plots.png"
    target_dimension_scatter_plots : str = "MHA_train_no_mass_loss_target_dimension_scatter_plots.png"
    invariant_mass_plots : str = "MHA_train_no_mass_loss_invariant_mass_plots.png"
    invariant_mass_data : str = "MHA_train_no_mass_loss_invariant_mass_data.txt"
