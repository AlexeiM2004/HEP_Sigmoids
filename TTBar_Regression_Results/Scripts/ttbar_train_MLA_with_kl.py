...
plt.tight_layout()
plt.savefig("ttbar_train_MLA_with_kl.png")
plt.show()
...
print("Saved predictions to ttbar_train_MLA_with_kl.txt")
print("Saved analysis plot to ttbar_train_MLA_with_kl.png")