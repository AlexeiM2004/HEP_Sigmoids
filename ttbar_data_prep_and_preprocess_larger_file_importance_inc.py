...
with h5py.File("../data/larger_importance_trimmed_ttbar_train.h5", "w") as f:
    f.create_dataset("X", data=X_train_scaled)
    f.create_dataset("Y", data=Y_train_scaled)

with h5py.File("../data/larger_importance_trimmed_ttbar_val.h5", "w") as f:
    f.create_dataset("X", data=X_val_scaled)
    f.create_dataset("Y", data=Y_val_scaled)

with h5py.File("../data/larger_importance_trimmed_ttbar_test.h5", "w") as f:
    f.create_dataset("X", data=X_test_scaled)
    f.create_dataset("Y", data=Y_test_scaled)

with h5py.File("../data/larger_importance_trimmed_scaler_info.h5", "w") as f:
    f.create_dataset("Y_mean", data=scaler_Y.mean_[0])
    f.create_dataset("Y_scale", data=scaler_Y.scale_[0])

print("Saved to larger_importance_trimmed_ttbar_train.h5")
print("Saved to larger_importance_trimmed_ttbar_val.h5")
print("Saved to larger_importance_trimmed_ttbar_test.h5")
print("Saved scaler info to larger_importance_trimmed_scaler_info.h5")
