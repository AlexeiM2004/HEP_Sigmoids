...
pred_boost = boost(top_pred, antitop_pred, lepton_plus_pred, lepton_minus_pred)
true_boost = boost(top_true, antitop_true, lepton_plus_true, lepton_minus_true)

# Order from your boost() function:
