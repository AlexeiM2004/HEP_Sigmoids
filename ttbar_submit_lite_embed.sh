...
cp /mnt/iusers01/fse-ugpgt01/phy01/q44882cb/HEP_Sigmoids/Scripts/ttbar_train_transformer_lite_embed.py ~/scratch/Scripts/

cd ~/scratch/Scripts
source ~/.venv/bin/activate

srun python ttbar_train_transformer_lite_embed.py