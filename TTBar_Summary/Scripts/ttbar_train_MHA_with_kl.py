...
model = Transformer(d_model=64,nhead=4,num_layers=4,dropout=0.1).to(device)
...
plt.tight_layout()
plt.savefig("ttbar_train_MHA_with_kl.png")
plt.show()
...
print("Saved predictions to ttbar_train_MHA_with_kl.txt")
print("Saved analysis plot to ttbar_train_MHA_with_kl.png")